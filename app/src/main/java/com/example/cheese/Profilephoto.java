    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.postprofImage:
                CropImage.activity().start(Profilephoto.this);
...
//                                    progressBar.setVisibility(View.INVISIBLE);
//                                    Toast.makeText(Profilephoto.this, "Profile Picture Upload Successful", Toast.LENGTH_SHORT).show();
...
//                                    finish();
                        ...
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Profilephoto.this, "Error Upload", Toast.LENGTH_SHORT).show();
